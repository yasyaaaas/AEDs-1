  ...
  while(!ehvalida)
    {
      ...
      {
        cout<<"\nData invalida! Coloque uma data válida:\n"<<endl;
      }
    }
}
void escreveData()
...
void aniversariantesMes(Pessoa* p[])
{
  ...
  cout<<"Coloque o mes: ";
  cin>>chave;
  cout<<"\nLista aniversariantes do mes: "<<endl;
  for(int i=0; i<cont; i++)
    {
...
int Menu()
{
  ...
  {
    cin.clear();
    throw runtime_error("Entrada inválida. Retornando ao menu principal.\n");
  }
  return op;
}
      ...
      try
        {
          ...
          switch(op)
          {
            case 0: cout<<"\nObrigada por utilizar o programa!"<<endl;
            break;
